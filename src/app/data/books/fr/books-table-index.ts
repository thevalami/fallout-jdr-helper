import {BOOK_ARMES_MUNITIONS_FR} from "./book-armes-munitions";
import {BOOK_GORGES_PENES_FR} from "./book-gorges-peness";
import {BOOK_GROGNAK_FR} from "./book-grognak";
import {BOOK_SURVIE_TERRES_DESOLEE_FR} from "./book-survie-terres-desolees";
import {BOOK_DORMIR_DEBOUT_FR} from "./book-dormir-debout";
import {BOOK_HOMMES_BOIS_FR} from "./book-homme-bois";
import {BOOK_INCREVABLE_FR} from "./book-increvables";
import {BOOK_MANUEL_ARMEE_USA_FR} from "./book-manuel-armee-usa";
import {BOOK_SCIENCE_TESLA_FR} from "./book-science-tesla";
import {BOOK_VIE_AMOUR_FR} from "./book-vie-amour";
import {BookType} from "../book-lang";

export const BOOK_TABLE_INDEX_FR: BookType[] = [
  {
    "Dice": 1,
    "Loot": "A couvert !",
  ...
  },
  {
    ...
    "Data": BOOK_GORGES_PENES_FR,
    "Description": "Selon le numéro du magazine trouvé, vous recevez une aptitude différente, dont vous ne pouvez bénéficier qu'une seule fois. Si vous apprenez cette aptitude plus tard, vous pouvez utiliser ce bénéfice une fois par scène. Lancez 1D20 pour déterminer quel numéro vous trouvez."
  },
  {
    "Dice": 6,
    "Loot": "Grognak le Barbare",
    "Data": BOOK_GROGNAK_FR,
    "Description": "Selon le numéro du magazine trouvé, vous recevez une aptitude différente, dont vous ne pouvez bénéficier qu'une seule fois. Si vous apprenez cette aptitude plus tard, vous pouvez utiliser ce bénéfice une fois par scène. Lancez 1D20 pour déterminer quel numéro vous trouvez."
  },
  {
    "Dice": 7,
    "Loot": "Guide de Survie des Terres Désolées",
    "Data": BOOK_SURVIE_TERRES_DESOLEE_FR,
    "Description": "Selon le numéro du magazine trouvé, vous recevez une aptitude différente, dont vous ne pouvez bénéficier qu'une seule fois. Si vous apprenez cette aptitude plus tard, vous pouvez utiliser ce bénéfice une fois par scène. Lancez 1D20 pour déterminer quel numéro vous trouvez."
  },
  {
    "Dice": 8,
    "Loot": "Histoires à Dormir Debout",
    "Data": BOOK_DORMIR_DEBOUT_FR,
  ...
  },
  {
    "Dice": 18,
    "Loot": "Science Tesla",
    "Data": BOOK_SCIENCE_TESLA_FR,
    "Description": "Selon le numéro du magazine trouvé, vous recevez une aptitude différente, dont vous ne pouvez bénéficier qu'une seule fois. Si vous apprenez cette aptitude plus tard, vous pouvez utiliser ce bénéfice une fois par scène. Lancez 1D20 pour déterminer quel numéro vous trouvez."
  },
  {
    "Dice": 19,
    "Loot": "Vie et Amour",
    "Data": BOOK_VIE_AMOUR_FR,
