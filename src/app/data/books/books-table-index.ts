import {BOOK_ARMES_MUNITIONS} from "./book-armes-munitions";
import {BOOK_GORGES_PENES} from "./book-gorges-peness";
import {BOOK_GROGNAK} from "./book-grognak";
import {BOOK_SURVIE_TERRES_DESOLEE} from "./book-survie-terres-desolees";
import {BOOK_DORMIR_DEBOUT} from "./book-dormir-debout";
import {BOOK_HOMMES_BOIS} from "./book-homme-bois";
import {BOOK_INCREVABLE} from "./book-increvables";
import {BOOK_MANUEL_ARMEE_USA} from "./book-manuel-armee-usa";
...
export const BOOK_TABLE_INDEX: BookType[] = [
  ...
  },
  {
    ...
    "Data": BOOK_SURVIE_TERRES_DESOLEE,
    "Description": "Selon le numéro du magazine trouvé, vous recevez une aptitude différente, dont vous ne pouvez bénéficier qu'une seule fois. Si vous apprenez cette aptitude plus tard, vous pouvez utiliser ce bénéfice une fois par scène. Lancez 1D20 pour déterminer quel numéro vous trouvez."
  },
  {
    "Dice": 8,
    "Loot": "Histoires à Dormir Debout",
    "Data": BOOK_DORMIR_DEBOUT,
